...
public class MenuView extends Application {
    ...
    public void start(Stage stage) throws IOException, UnsupportedAudioFileException, LineUnavailableException, URISyntaxException {
            ...
            Scene sceneMenu = new Scene(root, 500, 500);
    ...
    public static AudioInputStream audioMenu()throws UnsupportedAudioFileException, LineUnavailableException, URISyntaxException, IOException {
    	File mediaPath;
